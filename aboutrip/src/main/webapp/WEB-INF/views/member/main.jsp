	...
	<div class="body-main">
        <section class="clean-block clean-hero" style="background-image: url(&quot;${pageContext.request.contextPath}/resources/img/img/jeju.jpg&quot;);color: rgba(9, 162, 255, 0.4);">
            <div class="text">
                ...
                <p style="font-size: 20px;"><br><strong>여행을 여행답게</strong><br><br>국내 여행 일정부터 예약까지 <br>간편하게 어바웃트립으로 시작하세요.<br><br></p><button class="btn btn-outline-light btn-lg" type="button" style="font-size: 30px;" onclick="location.href='${pageContext.request.contextPath}/scheduler/mycalendar';">여행 떠나기 🛫<br></button>
            </div>
        </section>
	</div>
</div>