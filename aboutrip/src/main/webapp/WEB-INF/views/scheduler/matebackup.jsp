			...
			<div id="listMate">
				<table class='table mate-list'>
					...
					<c:forEach var="dto" items="${list }">
					       ...
					       <td width='50%' align='right'>
								...
								<c:choose>
									<c:when test="${sessionScope.member.userId==vo.userId || sessionScope.member.userId=='admin'}">
										<span class="deleteMate" style="cursor: pointer;" data-Num='${dto.num}' data-pageNo='${pageNo}'>삭제</span>
									</c:when>
								</c:choose>
					        </td>
					    </tr>
					    ...
					    <tr>
					        <td colspan="2">
					            <button type='button' class='btn btnMateAnswerLayout' data-mateNum='0'>답글 <span id="answerCount$0">0</span></button>
					        </td>
					    </tr>
								...
								<div style='clear:both; padding: 10px 0;'>
									...
									<div style='float: left; width:95%;'>
										...
										<div style='float: right;'>
											...
											<c:choose>
												<c:when test="${sessionScope.member.userId==vo.userId || sessionScope.member.userId=='admin'}">
													<span class='deleteMateAnswer' style='cursor: pointer;' data-mateNum='0' data-answer='0'>삭제</span>
												</c:when>
											</c:choose>
										</div>
									</div>
						...
						<!-- 여기까지 listMateAnswer.jsp -->
					            ...
					            <div style='clear: both; padding: 10px 10px;'>
					             ...
					             <div style='padding: 0 13px 10px 10px; text-align: right;'>
					                <button type='button' class='btn btnSendMateAnswer' data-Answer='0'>답글 등록</button>
					            </div>
