...
function changeDate(year) {
	var url="${pageContext.request.contextPath}/schedule/year?year="+year;
	location.href=url;
}
...
<div class="container body-container">
    ...
    <div class="body-main wx-900 content-center">
		...
		<div id="tab-content" style="clear:both; padding: 20px 0 0;">
			<table style="width: 805px; margin: 0 auto; border-spacing: 0;" >
				<tr height="60">
					<td align="center">
			...
			<table id="yearCalendar" style="width: 805px; margin:5px auto; border-spacing: 0; border-collapse: collapse;">
