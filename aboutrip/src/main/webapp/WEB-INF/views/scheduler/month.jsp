...
function changeDate(year, month) {
	var url="${pageContext.request.contextPath}/schedule/month?year="+year+"&month="+month;
	location.href=url;
}
...
$(function(){
	$("#btnScheduleSendOk").click(function(){
		...
		var url="${pageContext.request.contextPath}/schedule/insert";
		...
		$.ajax({
			...
			,success:function(data) {
				...
				if(state=="true") {
					...
					location.href="${pageContext.request.contextPath}/schedule/month?year="+y+"&month="+m;
				}
			}
...
$(function(){
	$(".scheduleSubject").click(function(){
		...
		var url="${pageContext.request.contextPath}/schedule/day?date="+date+"&num="+num;
		location.href=url;
	});
});
