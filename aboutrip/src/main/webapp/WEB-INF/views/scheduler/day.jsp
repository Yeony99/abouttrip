		...
		$.ajax({
			...
			,success:function(data) {
				...
				if(state=="true") {
					var date="${date}";
					var num="${dto.num}";
					location.href="${pageContext.request.contextPath}/schedule/day?date="+date+"&num="+num;
				}
			}
...
function deleteOk(num) {
	if(confirm("일정을 삭제 하시 겠습니까 ? ")) {
		var date="${date}";
		var url="${pageContext.request.contextPath}/schedule/delete?date="+date+"&num="+num;
		location.href=url;
	}
}
</c:if>
...
<div class="container body-container">
    ...
    <div class="body-main wx-900 content-center">
		...
		<div id="tab-content" style="clear:both; padding: 20px 0 0; ">
			<div style="clear: both;">
				<div id="scheduleLeft" style="float:left; padding-left: 0; padding-rigth: 0;">
					...
					<table id="smallCalendar" style="width: 280px; margin-top:5px; border-spacing: 1px; background: #ccc; " >
				...
				<div id="scheduleRight" style="float:left; padding-left: 30px; padding-rigth: 0; width: 600px; box-sizing: border-box;">
						...
						<table style="width: 100%; margin:5px 0 20px; border-spacing: 0; border-collapse: collapse;">
							...
							<c:forEach var="vo" items="${list}">
								<c:if test="${dto.num != vo.num}">
									<tr align="center" height="35" style="border-bottom: 1px solid #ccc;">
										<td>
											<c:choose>
										...
										<td align="left" style="padding-left: 10px;">
											<a href="${pageContext.request.contextPath}/schedule/day?date=${date}&num=${vo.num}">${vo.subject}</a>
										</td>
										<td>${vo.created}</td>
									</tr>
								</c:if>
