...
<div>
	<form id="" method="post">
		...
		<div>배송지 정보</div>
			...
			<input type="hidden" id="payment_name" name="payment_name" value="${payment_name}"> 
		<table>
			<tr>
				<td>구매자 이름</td>
			...
			<tr>
				<td>이메일</td>
				<td><input type="text" id="userId" name="userId" value="${member.userId}"></td>
			</tr>
			<tr>
				<td>전화번호</td>
			...
			<tr>
				<td>주소</td>
				<td><input type="text" id="address1" name="address1" value="${member.address1}" readonly="readonly"></td>
			</tr>
			<tr>
				<td>우편번호</td>
				<td><input type="text" id="zip" name="zip" value="${member.zip}" readonly="readonly"></td>
			</tr>

		</table>
		<button type="button" onclick="inisis()">결제하기</button>
	</form>
</div>