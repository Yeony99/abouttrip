...
<div>
	<form action="${pageContext.request.contentType}/product/repund"
		method="post">
		<table>
			<tr>
				<td>결제취소상품</td>
			...
			<tr>
				<td>취소 사유</td>
				<td colspan="2">><textarea name="reason"
			...
			<tr>
				<td>
					...
					<input type="hidden" name="cancel_request_ammount" value="${dto.price}">
				</td>
				<td></td>
				<td>
