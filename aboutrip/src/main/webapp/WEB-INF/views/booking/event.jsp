...
<div class="body-container">
	<div class="body-main">
        <section class="clean-block clean-hero" style="margin-top:80px; min-height:400px; background-image: url(&quot;${pageContext.request.contextPath}/resources/img/img/jeju_tour1.jpg&quot;);color: rgba(100, 100, 255, 0.1);">
            <div class="text">
				<h2 style="font-size:55px; color: skyblue; font-weight: bold">ABOUTRIP 초특가상품</h2><br>
				<h6 style="font-size:26px; color: white; font-weight: 600">어바웃트립의 초특가 이벤트 상품들을 소개합니다.</h6>
            </div>
        </section>
	</div>
	<div class="body-main" >
		<!-- 패키지 여행 -->
		<div id="main-container" style="background-color: rgb(250, 250, 250);">
			<div><span>&nbsp</span></div>
			<div class="img-container" style="margin-top: 100px">
				<div class="imgs" style="display: flex; flex-direction: row; align-content: stretch; justify-content: space-evenly; flex-wrap: wrap;">
					<div class="bximg"
						...
						<div style="width: 100%; height: 100%; padding-top: 100px;" >
							<h5 style="	color: darkblue; font-size: 1.0rem; font-weight: 700;">[aboutrip event]</h5>
					...
					<div class="bximg"
						...
						<div style="margin: 20px 10px 0px; height: 55px ">
							<span style="vertical-align: top; font-weight: bold; font-size: large;">[서귀포] 서귀포 KAL 호텔 문화마을 투어</span>							
						</div>
					...
					<div class="bximg"
						...
						<a href="#"><img class="box-img"
							...
							style="width: 100%; height: 200px; object-fit: cover;"> </a>
						<div style="margin: 20px 10px 0px; height: 55px ">
							<span style="vertical-align: top; font-weight: bold; font-size: large;">[제주] 제주도 올레길 와이너리 투어</span>							
						</div>
						<div style="margin: 0px 10px;">
					...
					<div class="bximg"
						...
						<a href="#"><img class="box-img"
							...
							style="width: 100%; height: 200px; object-fit: cover;"> </a>
						<div style="margin: 20px 10px 0px; height: 55px ">
							<span style="vertical-align: top; font-weight: bold; font-size: large;">[제주] 제주밤 야간 포토 스냅 투어</span>							
						</div>
						<div style="margin: 0px 10px;">
